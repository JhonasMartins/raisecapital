  ...
  useEffect(() => {
   ...
   return (
     <div className="min-h-dvh font-sans pt-28">
       ...
       {/* Hero com gradiente azul (mesmo padrão de /capte-recursos) */}
      <section className="relative -mt-28 pt-28 overflow-hidden">
        ...
        <div className="mx-auto max-w-6xl px-6 py-12">
          <h1 className="text-3xl sm:text-4xl font-semibold text-white">Ofertas</h1>
          <p className="mt-2 text-white/80">Explore oportunidades em diferentes setores e modelos de captação.</p>
          ...
          <div className="mt-6">
            <Card className="border border-white/20 bg-white/10 backdrop-blur-md shadow-lg">
              <CardContent className="p-4">
                ...
                <div className="hidden sm:grid sm:grid-cols-[1fr_auto_auto_auto] sm:items-end gap-4">
                  {/* Busca */}
                  <div className="relative">
                    <Search className="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 size-4 text-muted-foreground" />
                    <input
