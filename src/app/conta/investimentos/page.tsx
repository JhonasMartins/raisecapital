  ...
  return (
    <div className="w-full space-y-4 sm:space-y-6">
      ...
      <div className="grid grid-cols-1 xs:grid-cols-2 gap-3 sm:gap-4 lg:grid-cols-4">
        ...
        <Kpi title="Em análise" value={formatBRL(5000)} icon={<Hourglass className="size-4 sm:size-5 text-primary" />} />
        <Kpi title="Rentabilidade" value="+7,3%" icon={<TrendingUp className="size-4 sm:size-5 text-primary" />} />
      ...
      <Card>
        ...
        <CardContent className="space-y-3 sm:space-y-4">
          ...
          {qrCode ? (
            ...
            <div className="text-[10px] sm:text-xs text-muted-foreground text-center">Selecione uma oferta e gere o QRCode para investir via PIX.</div>
          )}
        </CardContent>
      </Card>
    </div>
