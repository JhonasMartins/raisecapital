...
export const metadata: Metadata = {
  title: "Código de Conduta — Raise Capital",
  description: "Código de Conduta oficial da Raise Capital.",
};

export default function Page() {
  const filePath = path.join(process.cwd(), "docs", "conduta.md");
      ...
      <div className="border-b bg-white/80 backdrop-blur-sm">
        <div className="mx-auto max-w-4xl px-6 py-8">
          ...
          <p className="mt-2 text-lg text-muted-foreground">
            Diretrizes e princípios éticos da Raise Capital
          </p>
        </div>
      </div>
